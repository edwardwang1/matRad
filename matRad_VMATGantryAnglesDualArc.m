...
pln.propStf.gantryAngles = [pln.propStf.gantryAngles, pln.propStf.gantryAngles(end:-1:1)];
pln.propStf.DAOGantryAngles = [pln.propStf.DAOGantryAngles, pln.propStf.DAOGantryAngles(end:-1:1)];
pln.propStf.FMOGantryAngles = [pln.propStf.FMOGantryAngles, pln.propStf.FMOGantryAngles(end:-1:1)];
