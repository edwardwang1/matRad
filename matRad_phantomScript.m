...
pln.propStf.bixelWidth    = 100;
pln.propStf.numOfBeams    = numel(pln.propStf.gantryAngles);

%pln.propStf.isoCenter     = ones(pln.propStf.numOfBeams,1) * matRad_getIsoCenter(cst,ct,0);
pln.propStf.isoCenter     = [200,110,200];
...
figure
plot([0:2:160],rescale(resultGUI.physicalDose(50:130,100,100)))
title('Percent Depth Dose Curve at Midline')
ylabel('Percent Dose [%]')
xlabel('Depth [mm]')
% hold on
% for i = 1
%     plot(rescale(resultGUI.physicalDose(:,100,100)))
% end

%% 
pln2 = pln;
pln2.propDoseCalc.useCustomPrimaryPhotonFluence = true;
resultGUI2 = matRad_calcDoseDirect(ct,stf,pln2,cst,w);
hold on
plot([0:2:160],rescale(resultGUI2.physicalDose(50:130,100,100)))
legend("Primary Fluence = False", "Primary Fluence = True")
%% Dose Calculation
